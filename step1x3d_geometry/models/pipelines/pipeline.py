...
class Step1X3DGeometryPipeline(
    ...
    def from_pretrained(cls, model_path, subfolder='.', **kwargs):
        ...
        # local_model_path = "/root/Polar3D/Train/outputs/step1x-3d-geometry/dinov2reglarge518-fluxflow-dit1300m/michelangelo-autoencoder+n32768+AdamWlr0.0001/ckpts/epoch=266-step=4000.ckpt/"
