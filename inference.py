...
def geometry_pipeline(input_image_path, save_glb_path):
    ...
    pipeline = Step1X3DGeometryPipeline.from_pretrained(
        "/root/Polar3D/Step1X-3D", subfolder='Step1X-3D-Geometry-1300m'
    ).to("cuda")
...
if __name__ == "__main__":
    image_path = "/root/dataset/Objaverse-2D/014e9cc64c414162893ab309f6adc944/normals_000_front_right.png"
    geometry_pipeline(image_path, "/root/Polar3D-2/InferenceOutputs/normal_bird_front_right.glb")
    # geometry_label_pipeline(image_path, "output/rgb_000_front-label.glb")
